...
internal readonly struct IntEqualizationFlowStrategy : IFlowStrategy<int, int> {
	...
	public int CalculateTransfer(
		...
		return (int)( ( source.Cell - destination.Cell ) * _viscosity / 2 );
	}
...
[TestFixture]
[ExcludeFromCodeCoverage]
internal sealed class GridFlowTests {

	private IGridFlow _flow;
